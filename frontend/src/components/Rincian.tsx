...
export default function Rincian({dataTripay}:{dataTripay:any}) {
                ...
                <dd className="mt-1 rounded-md bg-muted/55 p-4 text-sm leading-6 text-secondary-foreground sm:col-span-2 sm:mt-0 print:text-black">
                    <dl className="space-y-4 text-sm">
                        <div className="flex justify-between">
                            <dt className="font-medium text-secondary-foreground print:text-black">Harga</dt>
                            <dd className="text-secondary-foreground print:text-black">Rp  {addThousandSeparators(dataTripay.data.amount_received)}</dd>
                        </div>
                        <div className="flex justify-between">
                            <dt className="font-medium text-secondary-foreground print:text-black">Jumlah</dt>
                        ...
                        <div className="flex justify-between">
                            <dt className="font-medium text-secondary-foreground print:text-black">Subtotal</dt>
                            <dd className="text-secondary-foreground print:text-black">Rp  {addThousandSeparators(dataTripay.data.amount)}</dd>
                        </div>
                        <div className="flex justify-between">
                            <dt className="font-medium text-secondary-foreground print:text-black">Biaya</dt>
